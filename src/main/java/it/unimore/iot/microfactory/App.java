...
public class App {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            RobotCell robot = new RobotCell("cell-01", "robot", "robot-001");
            ConveyorBelt conveyor = new ConveyorBelt("cell-01", "conveyor", "conveyor-001");
            QualitySensor sensor = new QualitySensor("cell-01", "quality", "sensor-qs-001");
            ...
            // Add a shutdown hook to gracefully stop the manager and devices
